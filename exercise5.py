...
if __name__ == "__main__":
    n = 1000
    instructions = [
        f"scfg-toolkit/genFig -F 0 -c {n} -l 2 -L 9 > DATA/Tr-right-{n}",
        f"scfg-toolkit/genFig -F 1 -c {n} -l 2 -L 9 > DATA/Tr-equil-{n}",
        f"scfg-toolkit/genFig -F 2 -c {n} -l 2 -L 9 > DATA/Tr-isosc-{n}",
        f"scfg-toolkit/genFig -F 1 -c {n} -l 2 -L 9 > DATA/Tr-right-neg-{n}",
        f"scfg-toolkit/genFig -F 0 -c {int(n / 2)} -l 2 -L 9 > DATA/Tr-equil-neg-{n}",
        f"scfg-toolkit/genFig -F 2 -c {int(n / 2)} -l 2 -L 9 >> DATA/Tr-equil-neg-{n}",
        f"scfg-toolkit/genFig -F 1 -c {n} -l 2 -L 9 > DATA/Tr-isosc-neg-{n}",
